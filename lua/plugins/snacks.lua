    ...
    dashboard = {
      ...
      sections = {
        ...
        { pane = 2, icon = " ", title = "Projects", section = "projects", indent = 2, padding = 1 },
        {
          ...
          section = "terminal",
          -- cmd = "git --git-dir=$HOME/.cfg/ --work-tree=$HOME status --short --branch --renames",
          cmd = "git --git-dir=$HOME/.cfg/ --work-tree=$HOME --no-pager diff --stat -B -M -C",
          height = 6,
          padding = 1,
          ttl = 5 * 60,
          indent = 3,
        },
        {
          ...
          section = "terminal",
          cmd = "git --git-dir=$HOME/.config/LazyVim/.git/ --work-tree=$HOME/.config/LazyVim/ --no-pager diff --stat -B -M -C",
          height = 6,
          padding = 1,
          ttl = 5 * 60,
          indent = 3,
